...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.play.setGeometry(QtCore.QRect(450, 510, 89, 25))
        self.play.setObjectName("play")
        self.video_view = QtWidgets.QLabel(self.centralWidget)
        self.video_view.setGeometry(QtCore.QRect(330, 20, 541, 261))
        ...
        self.res_list.setGeometry(QtCore.QRect(10, 290, 1131, 211))
        self.res_list.setFlow(QtWidgets.QListView.LeftToRight)
        self.res_list.setObjectName("res_list")
        self.pause = QtWidgets.QPushButton(self.centralWidget)
        self.pause.setGeometry(QtCore.QRect(710, 510, 89, 25))
        self.pause.setObjectName("pause")
        MainWindow.setCentralWidget(self.centralWidget)
        self.menuBar = QtWidgets.QMenuBar(MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1164, 28))
